...
const panelFooter = () => `<footer class="master-panel-footer os-footer"><button class="master-panel-continue os-bottom-control" type="button" tabindex="-1" aria-hidden="true"><span class="swipe-control"><span></span><span class="swipe-control-line"></span></span></button></footer>`;
