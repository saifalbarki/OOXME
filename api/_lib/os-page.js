...
const panelFooter = () => `<footer class="master-panel-footer homepage-bottom-navigation os-footer" data-authenticated-navigation><button class="master-panel-continue" type="button" data-auth-nav-trigger aria-label="Open navigation" aria-expanded="false"><span class="swipe-control"><span></span><span class="swipe-control-line"></span></span></button><nav class="homepage-bottom-menu" data-auth-nav-menu data-active="home" aria-label="Navigation"><span class="homepage-bottom-menu-indicator" aria-hidden="true"></span><button type="button" data-auth-nav-item="account" data-auth-nav-destination="/os/accounts" aria-pressed="false"><img src="/assets/icons/New/PROFILE.svg" alt=""></button><button type="button" data-auth-nav-item="gallery" aria-pressed="false"><img src="/assets/icons/New/GALLERY.svg" alt=""></button><button type="button" data-auth-nav-item="home" data-auth-nav-destination="/os" aria-pressed="true"><img src="/assets/icons/New/HOME.svg" alt=""></button><button type="button" data-auth-nav-item="search" aria-pressed="false"><img src="/assets/icons/New/SEARCH.svg" alt=""></button><button type="button" data-auth-nav-item="menu" aria-pressed="false"><img src="/assets/icons/New/NOTIFICATION.svg" alt=""></button></nav></footer>`;
