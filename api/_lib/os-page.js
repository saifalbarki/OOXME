...
const dashboardPanel = items => `<section class="master-panel-screen is-active os-screen"><article class="master-panel os-panel">${panelHeader()}<section class="master-panel-content os-content os-dashboard-content"><div class="os-title-row"><h1 data-os-text="title">OOXME OS</h1></div>${cards(items)}</section>${panelFooter(true)}</article></section>`;
