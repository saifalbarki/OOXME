...
const dashboardFooter = () => `<footer class="master-panel-footer homepage-bottom-navigation os-footer os-dashboard-footer" data-authenticated-navigation data-os-panel-navigation><button class="master-panel-continue" type="button" data-auth-nav-trigger aria-label="Open navigation" aria-expanded="false"><span class="swipe-control"><span></span><span class="swipe-control-line"></span></span></button><nav class="homepage-bottom-menu" data-auth-nav-menu data-active="home" aria-label="Navigation"><span class="homepage-bottom-menu-indicator" aria-hidden="true"></span><button class="homepage-bottom-menu-button" type="button" data-auth-nav-item="previous" data-auth-nav-panel="previous" aria-label="Previous panel" aria-pressed="false"><img src="/assets/icons/New/ARROW LEFT.svg" alt=""></button><button class="homepage-bottom-menu-button is-active" type="button" data-auth-nav-item="home" data-auth-nav-logout aria-label="Log out" aria-pressed="true"><img src="/assets/icons/New/HOME.svg" alt=""></button><button class="homepage-bottom-menu-button" type="button" data-auth-nav-item="next" data-auth-nav-panel="next" aria-label="Next panel" aria-pressed="false"><img src="/assets/icons/New/ARROW RIGHT.svg" alt=""></button></nav></footer>`;
