...
const pageRoutes = { '/': 'index.html', '/brands': 'studio.html', '/gallery': 'selected-works.html', '/brand': 'brand-management-new.html', '/consultation': 'consultation.html', '/x': 'x.html', '/rpn': 'rpn.html', '/update': 'update.html' };
