...
const pageRoutes = { '/': 'index.html', '/brands': 'studio.html', '/gallery': 'selected-works.html', '/brand': 'brand-management-new.html', '/consultation': 'consultation.html', '/x': 'x.html', '/rpn': 'rpn.html' };
...
const server = http.createServer((request, response) => {
  ...
  fs.readFile(target, (error, content) => {
    ...
    const isStandalonePreview = ['x.html', 'rpn.html'].includes(path.basename(target).toLowerCase());
