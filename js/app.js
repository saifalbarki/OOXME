...
Object.assign(copy.en,{navConsultation:'Consultation',consultationLabel:'Consultation',consultationHeading:'Let’s Build<br>Your Business Together',consultationCopy:'Book a consultation with OOXME to discuss your business, identify opportunities, and create a clear growth strategy.',consultationCta:'Schedule Consultation <span aria-hidden="true">↗</span>'});
Object.assign(copy.ar,{navConsultation:'استشارة',consultationLabel:'استشارة',consultationHeading:'لنبنِ<br>نمو أعمالك معًا',consultationCopy:'احجز جلسة استشارية مع اوكسوم لمناقشة أعمالك وتحديد الفرص وبناء استراتيجية نمو واضحة.',consultationCta:'جدولة استشارة <span aria-hidden="true">↗</span>'});
const sectionLabels={
  en:['Creative Work','Creative Services','Process','Consultation','Contact'],
  ar:['الأعمال الإبداعية','الخدمات الإبداعية','المنهجية','استشارة','تواصل معنا']
};
...
function setLanguage(next){
  ...
  langEn.textContent=next==='en'?'EN':'ج';
  langEn.classList.toggle('is-arabic-script',next==='ar');
  langAlt.textContent=next==='en'?'AR':'ع';
  langAlt.classList.toggle('is-arabic-script',next==='ar');
  langEn.classList.toggle('is-active',next==='en');
  langAlt.classList.toggle('is-active',next==='ar');
