(() => {
  ...
  if (!page || !content || !composer || !menu || !utilities || !addButton || !submitButton || !themeButton || !languageButton || !firstGroup || !title || !output || !textTwo || !textTwoOutput || !textThree || !textThreeOutput || !sectionTwoGroup || !sectionTwoTitle || !sectionTwoTitleOutput || !sectionTwoHero || !serviceStack || serviceBoxes.length !== 4 || serviceTitles.length !== 4 || serviceDescriptions.length !== 4 || serviceItemGroups.some((items) => items.length !== 4) || !sectionOneCta || !sectionOneNextCopy || !sectionTwoCta || !sectionTwoNextCopy || !consultationCta) return;
  ...
  addButton.addEventListener('click', () => { window.location.assign('/'); });
