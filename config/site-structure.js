...
export const searchNavigation = [
  ...
  { href: '/project-albasri-commercial-group#hfadhi-project', en: 'Alhafadhi', ar: 'الحفاظي' },
  ...
  { href: '/project-sawa-university#next-project', en: 'VIIR', ar: 'فيير' },
...
export const obsoleteRouteRedirects = {
  ...
  'project-viir': '/project-sawa-university#next-project',
};
