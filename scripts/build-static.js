...
const pageOutputs = { 'index.html': 'index.html', 'studio.html': 'brands.html', 'selected-works.html': 'gallery.html', 'brand-management-new.html': 'brand.html', 'consultation.html': 'consultation.html', 's.html': 's.html' };
...
for (const name of fs.readdirSync(sourceRoot)) {
  if (pageOutputs[name]) {
    ...
    const isStandalonePreview = name === 's.html';
